...
class MealProfile {
    ...
    final boolean highProtein;
    final boolean dairyFree;
    final boolean nutFree;
    final boolean under30Minutes;

    MealProfile(DietGoal goal, MealTime mealTime, MealComplexity complexity, boolean highProtein,
...
class MealRecommendation {
    ...
    MealRecommendation(String consensusTitle, int consensusScore, String consensusSummary, List<String> modelOutputs,
    ...
    String getConsensusSummary() {
        return consensusSummary;
    }

    List<String> getModelOutputs() {
        return modelOutputs;
    }
...
class MealSuggestionEngine {
    MealRecommendation recommend(MealProfile profile) {
